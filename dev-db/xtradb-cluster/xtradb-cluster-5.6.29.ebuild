...
MY_PS="${MY_P}.${MY_POINT}-rel76.2-${MY_PATCH}"
MY_PVP="${MY_PS}.${MY_BUILD}"
MY_PN="Percona-XtraDB-Cluster-${MY_PVP}.Linux.x86_64.ssl${MY_SSL}"

SRC_URI="amd64? (
http://www.percona.com/downloads/Percona-XtraDB-Cluster-56/Percona-XtraDB-Cluster-${MY_P}.${MY_POINT}-${MY_PATCH}/binary/tarball/Percona-XtraDB-Cluster-${MY_PVP}.Linux.x86_64.ssl${MY_SSL}.tar.gz
)
"
